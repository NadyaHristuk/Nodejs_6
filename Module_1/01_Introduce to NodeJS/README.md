...
Для примера можете запустить два проекта (01_1_Alert, 01_2_Variable), которые лежат в этом же каталоге. Необходимо перейти в соответсующую папку, открыть терминал и ввести `npm start`